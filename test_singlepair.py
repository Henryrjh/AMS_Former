...
if __name__ == '__main__':
    ...
    parser.add_argument('-ref_path', type=str, default = 'phd/ref.png' , help='reference image dir')
    parser.add_argument('-sen_path', type=str, default = 'phd/sen.png' , help='sensed image dir')

    parser.add_argument('-result_path', type=str, default = 'result.png' , help='match result')
